    ...
    <nav class="w-full bg-white shadow-md fixed top-0 z-50">
        <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16 sm:h-20">
                <!-- Logo -->
                <div class="flex items-center flex-shrink-0" :class="locale === 'ar' ? 'space-x-reverse space-x-2' : 'space-x-2'">
                ...
                <div
                    ...
                    <!-- Language Switcher -->
                    <div class="flex items-center bg-gray-100 rounded-full p-1" :class="locale === 'ar' ? 'space-x-reverse space-x-2' : 'space-x-2'">
                ...
                <!-- Mobile Menu Button -->
                <button @click="open = !open" class="md:hidden text-gray-700 focus:outline-none flex-shrink-0" aria-label="Toggle menu">
            ...
            <div x-show="open" class="md:hidden pb-4 space-y-3">
                ...
                <div class="flex items-center bg-gray-100 rounded-full p-1 w-max" :class="locale === 'ar' ? 'space-x-reverse space-x-2' : 'space-x-2'">
                    <button @click="window.location.href = '{{ route('locale.change', 'en') }}'"
                        :class="locale === 'en' ? 'bg-red-600 text-white' : 'text-gray-600'"
